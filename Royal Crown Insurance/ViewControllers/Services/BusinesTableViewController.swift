//
//  BusinesTableViewController.swift
...
class BusinesTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        ServerManager.manager.getServices(params: ["service_type" : "business"]) { (array) in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "BusinesServices", for: indexPath)
...
extension BusinesTableViewController {
...
private extension BusinesTableViewController {
